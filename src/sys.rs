...
pub const __GLIBC_MINOR__: ::libc::c_uint = 26;
...
pub const __GLIBC_USE_IEC_60559_TYPES_EXT: ::libc::c_uint = 0;
...
extern "C" {
    pub fn blake2s_init(S: *mut blake2s_state, outlen: usize) -> ::libc::c_int;
}
extern "C" {
...
extern "C" {
    pub fn blake2sp_init(S: *mut blake2sp_state, outlen: usize) -> ::libc::c_int;
}
extern "C" {
...
extern "C" {
    pub fn blake2bp_init(S: *mut blake2bp_state, outlen: usize) -> ::libc::c_int;
}
extern "C" {
...
extern "C" {
    pub fn blake2xs_init(S: *mut blake2xs_state, outlen: usize) -> ::libc::c_int;
}
extern "C" {
...
extern "C" {
    pub fn blake2xb_init(S: *mut blake2xb_state, outlen: usize) -> ::libc::c_int;
}
extern "C" {
